...
// -------
//
function ciniki_reslib_categoryHistory($ciniki) {
    //
    ...
    $rc = ciniki_reslib_checkAccess($ciniki, $args['tnid'], 'ciniki.reslib.categoryHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.reslib', 'ciniki_reslib_history', $args['tnid'], 'ciniki_reslib_categories', $args['category_id'], $args['field']);
}
?>
